---
layout: post
title: "Inflação: O que É e Como Afeta a Vida"
description: "Entenda a inflação como fenômeno monetário e a crítica austríaca às políticas do banco central."
date: 2016-02-14
---
...
### A Definição Austríaca

**Inflação** = Aumento na oferta de moeda e crédito
**Inflação de Preços** = O sintoma — aumento nos preços — que resulta da expansão monetária

O governo e os bancos centrais preferem usar "inflação" para significar apenas o aumento de preços, obscurecendo a causa real: a expansão da base monetária.

### A Definição Mainstream

Keynesianistas e bancos centrais definem inflação como "aumento sustentado no nível geral de preços". Mas focam no sintoma (preços) em vez da causa (moeda).

## O Mecanismo da Inflação

### A Inflação Como Imposto

Quando o governo expande a oferta monetária, ele essencialmente taxa os detentores de moeda — o valor de cada unidade monetária existente cai proporcionalmente à nova emissão.
...
1. O banco central reduz as taxas de juros abaixo do "nível natural"
2. Crédito se expande, encorajando investimento e consumo
...
1. [O que é Economia? Conceitos Fundamentais]({{ site.baseurl }}/o-que-e-economia-conceitos-fundamentais)
2. [Oferta e Procura: Como Funcionam]({{ site.baseurl }}/oferta-e-procura-como-funcionam)
3. [Inflação: O que É e Como Afeta a Vida]({{ site.baseurl }}/inflacao-o-que-e-e-como-afeta-a-vida) ← *você está aqui*

## Leia Mais

- Mises, L. von. *Human Action: A Treatise on Economics*. Ludwig von Mises Institute, 1949.
- Hayek, F. A. von. *Monetary Theory and the Trade Cycle*. Ludwig von Mises Institute, 1929.
...
- Hazlitt, H. *From Bretton Woods to the Inflation Tax*. Ludwig von Mises Institute, 1976.
